...
Das **SetMissedCallNotificationEnabledResponse** -Element definiert eine Antwort auf eine [SetMissedCallNotificationEnabled-Vorgang (UM-Webdienst)](setmissedcallnotificationenabled-operation-um-web-service.md) an. 
