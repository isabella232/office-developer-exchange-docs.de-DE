...
Das **GroupType** -Element gibt die Gruppenklasse einer Chatgruppe (Instant Messaging) an. 
...
Der Textwert des **GroupType** -Elements ist ein String-Wert, der den Typ der Gruppe angibt. 
