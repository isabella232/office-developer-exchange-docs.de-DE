...
---
# <a name="values-arrayofstringvaluetype"></a>Werte (ArrayOfStringValueType)

**Values** -Element gibt die Werte in einem Array von Persona-Eigenschaften, die ein Array Marken zugeordnet. 
