...
---
# <a name="setoofstatusresponse-um-web-service"></a>SetOofStatusResponse (um-Webdienst)

Das **SetOofStatusResponse** -Element definiert eine Antwort auf eine Anforderung des [SetOofStatus-Vorgangs (um-Webdienst)](setoofstatus-operation-um-web-service.md) . 
