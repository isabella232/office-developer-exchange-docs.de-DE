...
Das **AddImContactToGroup** -Element definiert eine Anforderung an einen vorhandenen instant messaging-Kontakt zu einer instant messaging-Gruppe hinzufügen. 
