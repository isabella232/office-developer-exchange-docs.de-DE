...
ms.locfileid: "59536141"
---
# <a name="createuserconfigurationresponsemessage"></a>CreateUserConfigurationResponseMessage

Das **CreateUserConfigurationResponseMessage-Element** enthält den Status und das Ergebnis einer einzelnen **CreateUserConfiguration-Anforderung.** 
