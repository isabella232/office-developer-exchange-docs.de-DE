...
Der Textwert stellt die e-Mail-Adresse eines Benutzers.
  
## <a name="remarks"></a>Hinweise

[LegacyDN (POX)](legacydn-pox.md) -Element enthält eine alternative-Element für eine autoermittlungsanforderung für die an. 
