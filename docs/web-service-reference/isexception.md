...
Das **IsException** -Element gibt an, ob das Master-Shape eine Instanz eines sich wiederholenden Kalenderelements geändert wird. 
...
|:-----|:-----|
|[CalendarEventDetails](calendareventdetails.md) <br/> |Zusätzliche Informationen zu einem Kalenderereignis.  <br/> Es folgt der 2.0 XPath-Ausdruck, der dieses Element:  <br/>  `/GetUserAvailabilityResponse/FreeBusyResponseArray/FreeBusyResponse/FreeBusyView/CalendarEventArray/CalendarEvent[i]/CalendarEventDetails` <br/> |
