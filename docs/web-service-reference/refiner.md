...
Das **Einschränkung** -Element gibt eine Einschränkung für die Suche an. 
...
[Name (Zeichenfolge)](name-string.md) | [Wert](value.md) | [Count](count.md) | [Token (Zeichenfolge)](token-string.md)
