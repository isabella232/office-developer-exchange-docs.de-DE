...
Das **EmailAddressEntity** -Element gibt eine einzelne e-Mail-Adress Entität an. 
...
|:-----|:-----|
|[E-mailemail (Zeichenfolge)](emailaddress-string.md) <br/> |Gibt eine einzelne e-Mail-Adresse an.  <br/> |
