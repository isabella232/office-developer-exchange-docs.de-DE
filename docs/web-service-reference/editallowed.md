...
Der Textwert **true** für das **EditAllowed** -Element gibt an, dass (Information Rights Management, IRM) bearbeitet werden kann. Der Wert **false** gibt an, dass IRM nicht bearbeitet werden kann. 
