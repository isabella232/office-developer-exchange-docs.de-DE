...
Das **Telefon** -Element gibt eine einzelne Telefonnummer ein, die sich aus entitätenextraktion ein Telefon Zahl ergibt. 
...
[Position](position.md) | ["originalphonestring"](originalphonestring.md) | ["phonestring"](phonestring.md) | [Typs (Zeichenfolge)](type-string.md)
