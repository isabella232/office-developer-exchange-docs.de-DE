...
---
# <a name="birthday"></a>Geburtstag

Das **Geburtstags** Element stellt das Geburtsdatum eines Kontakts dar. 
...
Ein Textwert, der ein Datum und eine Uhrzeit darstellt, ist erforderlich.
