...
ms.locfileid: "59541798"
---
# <a name="updatedelegateresponse"></a>UpdateDelegateResponse

Das **UpdateDelegateResponse-Element** enthält den Status und das Ergebnis einer [UpdateDelegate-Vorgangsanforderung.](updatedelegate-operation.md) 
