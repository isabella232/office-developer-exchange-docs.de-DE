...
Das **comment** -Element enthält den Kommentar, der einem verwalteten Ordner zugeordnet ist. 
...
Der Wert Text stellt den Kommentar dar, der einem verwalteten Ordner zugeordnet ist.
