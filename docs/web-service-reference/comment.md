...
Das **Comment** -Element enthält den Kommentar, der mit einem verwalteten Ordner verbunden ist. 
...
Der Textwert der den Kommentar darstellt, der mit einem verwalteten Ordner verknüpft ist.
