...
**SourceId** -Element gibt den Bezeichner des attributierten Kontakts in eine Rolle. 
...
|:-----|:-----|
|Id  <br/> |Der Textwert des **Id** -Attributs ist der Bezeichner des Kontakts.  <br/> |
|ChangeKey  <br/> |Der Textwert des **ChangeKey** -Attributs ist der Key ändern des Kontakts.  <br/> |
