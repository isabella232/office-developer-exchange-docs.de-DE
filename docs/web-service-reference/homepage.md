...
Das **HomePage** -Element gibt die URL, die Standard-Startseite für den verwalteten Ordner werden. 
...
Der Textwert ist ein Zeichenfolgenwert, der eine URL darstellt.
