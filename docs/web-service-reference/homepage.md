...
Das **Homepage** -Element gibt die URL an, die als Standardstartseite für den verwalteten Ordner dient. 
...
Der Text-Wert ist ein String-Wert, der eine URL darstellt.
