...
description: Das ForwardItem-Element enthält ein Exchange Speicherelement, das an Empfänger weitergeleitet werden soll.
ms.openlocfilehash: c5215c91c6ea676bd6d5954eb2bda84f766c7efb
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: de-DE
ms.lasthandoff: 09/24/2021
ms.locfileid: "59545069"
---
# <a name="forwarditem"></a>ForwardItem

Das **ForwardItem-Element** enthält ein Exchange Speicherelement, das an Empfänger weitergeleitet werden soll. 
...
Das [From-Element](from.md) sollte auf die E-Mail-Adresse des Prinzipals festgelegt werden, wenn ein Element von einem Delegaten weitergeleitet wird. Wenn der Delegat die [From-Eigenschaft](from.md) nicht festgelegt hat, scheint das Element direkt aus dem Postfach der Stellvertretung gesendet worden zu sein. 
