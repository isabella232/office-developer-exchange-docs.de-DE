...
**ReminderMinutesBeforeStart** -Element stellt die Anzahl der Minuten, bevor ein Ereignis tritt auf, wenn eine Erinnerung angezeigt wird. 
...
Der Textwert darstellt, in Minuten ein, die Zeit, bevor ein Ereignis tritt auf, wenn eine Erinnerung angezeigt wird.
