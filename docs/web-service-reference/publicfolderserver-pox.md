...
Das **PublicFolderServer** -Element enthält den vollqualifizierten Domänennamen (FQDN) des Servers für Öffentliche Ordner für den Benutzer. 
...
Der Textwert stellt den FQDN des Servers für Öffentliche Ordner für den Benutzer.
  
## <a name="remarks"></a>Hinweise

Das **PublicFolderServer** -Element ist ein optionales untergeordnetes Element des **Protokoll** -Elements. 
