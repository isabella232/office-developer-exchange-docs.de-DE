...
Das **GetUserConfigurationResponseMessage** -Element stellt eine Antwort dar, die ein Benutzer Konfigurationsobjekt zurückgibt. 
...
|[UserConfiguration](userconfiguration.md) <br/> |Enthält ein einzelnes Benutzer Konfigurationsobjekt.  <br/> |
