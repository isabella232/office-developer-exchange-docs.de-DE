...
description: Das GetUserConfigurationResponseMessage-Element stellt eine Antwort dar, die ein Benutzerkonfigurationsobjekt zurückgibt.
ms.openlocfilehash: 342d97aa34c3cd925114cf378b2cdbecbc9ca953
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: de-DE
ms.lasthandoff: 09/24/2021
ms.locfileid: "59516839"
---
# <a name="getuserconfigurationresponsemessage"></a>GetUserConfigurationResponseMessage

Das **GetUserConfigurationResponseMessage-Element** stellt eine Antwort dar, die ein Benutzerkonfigurationsobjekt zurückgibt. 
...
|[UserConfiguration](userconfiguration.md) <br/> |Enthält ein einzelnes Benutzerkonfigurationsobjekt.  <br/> |
