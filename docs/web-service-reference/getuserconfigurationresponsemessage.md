...
Das Element **GetUserConfigurationResponseMessage** stellt eine Antwort, die ein Benutzer Configuration-Objekt zurückgibt. 
...
|[UserConfiguration](userconfiguration.md) <br/> |Ein einzelner Benutzer Configuration-Objekt enthält.  <br/> |
