...
Das Element **"phonestring"** gibt die Telefonnummer für einen extrahierten Kontakt an. 
...
Der Textwert des **PhoneSting** -Elements ist die Rufnummer eines Kontakts extrahierten. 
