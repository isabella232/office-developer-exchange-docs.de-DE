...
Das **Unternehmen** Element stellt die Auflistung der Unternehmen, die einen Kontakt oder eine Aufgabe zugeordnet sind. 
...
|:-----|:-----|
|[String](string.md) <br/> |Stellt den Namen eines Unternehmens.  <br/> |
