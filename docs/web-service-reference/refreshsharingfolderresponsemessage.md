...
Das **RefreshSharingFolderResponseMessage** -Element enthält den Status und das Ergebnis einer einzelnen [RefreshSharingFolder-Vorgangs](refreshsharingfolder-operation.md) Anforderung. 
