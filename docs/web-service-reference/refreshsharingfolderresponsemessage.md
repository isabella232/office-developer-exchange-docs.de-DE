...
Das **RefreshSharingFolderResponseMessage** -Element enthält, der Status und das Ergebnis einer einzelnen Anforderung [RefreshSharingFolder Vorgang](refreshsharingfolder-operation.md) . 
