...
Das **Value** -Element stellt einen Benutzer Einstellung-Wert. 
...
|:-----|:-----|
|[UserSetting (SOAP)](usersetting-soap.md) <br/> |Stellt das Basiselement für alle benutzereinstellungen.  <br/> |
|[DomainSetting (SOAP)](domainsetting-soap.md) <br/> |Stellt das Basiselement für alle domäneneinstellungen, die.  <br/> |
