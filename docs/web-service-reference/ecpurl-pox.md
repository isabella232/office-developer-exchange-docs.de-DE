...
Das **EcpUrl** -Element gibt die URL der Exchange-Systemsteuerung für einen e-Mail-aktivierten Benutzer. 
...
Der Textwert darstellt die URL des der Exchange-Systemsteuerung für den Benutzer.
  
## <a name="remarks"></a>Hinweise

Das **EcpUrl** -Element ist ein optionales untergeordnetes Element des **Protokoll** -Elements. 
