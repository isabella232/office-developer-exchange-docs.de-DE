...
|[ParentFolderId](parentfolderid.md) <br/> |Stellt den Bezeichner des übergeordneten Ordners dar, der den Ordner Aufgaben enthält.  <br/> |
|[FolderClass](folderclass.md) <br/> |Stellt die Folder-Klasse für einen Aufgabenordner dar.  <br/> |
|[DisplayName (Zeichenfolge)](displayname-string.md) <br/> |Enthält den Anzeigenamen eines Aufgabenordners.  <br/> |
|[Total count](totalcount.md) <br/> |Stellt die Gesamtanzahl der Elemente in einem Aufgabenordner dar.  <br/> |
...
|[ExtendedProperty](extendedproperty.md) <br/> |Identifiziert erweiterte Eigenschaften für einen Aufgabenordner.  <br/> |
