...
**TotalWork** -Element enthält eine Beschreibung der Umfang der Arbeit mit einer Aufgabe verbunden ist. 
...
Der Textwert entspricht eine ganze Zahl, die die Gesamtmenge der Arbeit darstellt, die mit einer Aufgabe verbunden ist.
