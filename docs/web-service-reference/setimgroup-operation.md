...
description: Hier finden Sie Informationen zum EWS-Vorgang "SetImGroup".
ms.openlocfilehash: 3499647aa9aaa62b56336f5e016344a05cf7578f
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: de-DE
ms.lasthandoff: 09/24/2021
ms.locfileid: "59534293"
---
# <a name="setimgroup-operation"></a>SetImGroup-Vorgang

Hier finden Sie Informationen zum **EWS-Vorgang "SetImGroup".** 
  
Der **SetImGroup-Vorgang** ändert den Anzeigenamen einer Chatgruppe. 
  
Dieser Vorgang wurde in Exchange Server 2013 eingeführt.
  
## <a name="using-the-setimgroup-operation"></a>Verwenden des SetImGroup-Vorgangs

Der **SetImGroup-Vorgang** verwendet nur ein einzelnes Anzeigenamenargument. 
...
## <a name="setimgroup-operation-request-example"></a>SetImGroup-Vorgangsanforderungsbeispiel

Das folgende Beispiel einer **SetImGroup-Vorgangsanforderung** zeigt, wie Sie den Anzeigenamen einer Chatgruppe in "MyNewGroupName" ändern. 
  
> [!NOTE]
> Der Exchange Speicherbezeichner wurde gekürzt, um die Lesbarkeit zu gewährleisten. 
...
## <a name="successful-setimgroup-operation-response"></a>Erfolgreiche Antwort auf SetImGroup-Vorgang
...
## <a name="setimgroup-operation-error-response"></a>Fehlerantwort beim SetImGroup-Vorgang

Das folgende Beispiel zeigt eine Fehlerantwort auf eine **SetImGroup-Vorgangsanforderung.** Die folgende Fehlerantwort tritt auf, wenn versucht wird, den Anzeigenamen der Gruppe in den vorhandenen Gruppenanzeigenamen zu ändern. 
