...
Das **DisplayNameFirstLastHeader** -Element gibt die Kopfzeile für den Anzeigenamen, den Vornamen zuerst an. 
...
Der Textwert der **DisplayNameFirstLastHeader** -Element ist ein String-Wert, der die Kopfzeile angibt. 
