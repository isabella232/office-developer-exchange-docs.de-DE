...
Das **EmptyFolder** -Element definiert eine Anforderung zum leeren eines Ordners in einem Postfach im Exchange-Informationsspeicher. Optional können Unterordner auch gelöscht werden, wenn der Ordner geleert wird. 
...
|:-----|:-----|
|**Deletetypeharddelete** <br/> |Gibt an, wie ein Ordner geleert wird. Dieses Attribut ist erforderlich.  <br/> |
...
|**Wert**|**Beschreibung**|
|:-----|:-----|
|HardDelete  <br/> |Nachrichten und Ordner werden endgültig aus dem Speicher entfernt.  <br/> |
|SoftDelete  <br/> |Wenn der Papierkorb aktiviert ist, werden Nachrichten und Ordner in den Papierkorb verschoben.  <br/> |
