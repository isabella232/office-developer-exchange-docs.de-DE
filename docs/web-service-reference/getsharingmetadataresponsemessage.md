...
Das **GetSharingMetadataResponseMessage** -Element enthält den Status und das Ergebnis einer einzelnen [GetSharingMetadata-Vorgangs](getsharingmetadata-operation.md) Anforderung. 
...
|[EncryptedSharedFolderDataCollection](encryptedsharedfolderdatacollection.md) <br/> |Enthält eine Auflistung von Datenstrukturen, die ein Client verwenden kann, um die Freigabe seiner Kalender-oder Kontaktdaten für andere Clients zu autorisieren.  <br/> |
|[InvalidRecipients](invalidrecipients.md) <br/> |Stellt die Empfänger der Anforderung für die Ordnerfreigabe dar, die ungültig sind.  <br/> |
