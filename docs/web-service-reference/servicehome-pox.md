...
Das **ServiceHome** -Element enthält die URL der Startseite des Internet-Dienstanbieters (ISP). 
...
Der Textwert stellt die URL der Startseite des Internetdienstanbieters.
