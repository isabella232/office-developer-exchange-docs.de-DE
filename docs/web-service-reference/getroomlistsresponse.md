...
Das **GetRoomListsResponse** -Element definiert die Antwort von einer [GetRoomLists-Vorgangs](getroomlists-operation.md) Anforderung. 
...
|[RoomLists](roomlists.md) <br/> |Enthält eine Liste von e-Mail-Adressen und Anzeigenamen, die Listen von Besprechungsräumen darstellen.  <br/> |
