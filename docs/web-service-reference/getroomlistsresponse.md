...
Das **GetRoomListsResponse** -Element definiert die Antwort von einer Anforderung [GetRoomLists Vorgang](getroomlists-operation.md) . 
...
|[RoomLists](roomlists.md) <br/> |Enthält eine Liste der e-Mail-Adressen und Anzeigenamen, die Listen von Besprechungsräumen darstellen.  <br/> |
