...
description: Das GetRoomListsResponse-Element definiert die Antwort aus einer GetRoomLists-Vorgangsanforderung.
ms.openlocfilehash: 4b8eb3cc596debd1110849ac10edaed9308708f3
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: de-DE
ms.lasthandoff: 09/24/2021
ms.locfileid: "59518302"
---
# <a name="getroomlistsresponse"></a>GetRoomListsResponse

Das **GetRoomListsResponse-Element** definiert die Antwort aus einer [GetRoomLists-Vorgangsanforderung.](getroomlists-operation.md) 
...
|[RoomLists](roomlists.md) <br/> |Stellt eine Liste von E-Mail-Adressen und Anzeigenamen bereit, die Listen von Besprechungsräumen darstellen.  <br/> |
