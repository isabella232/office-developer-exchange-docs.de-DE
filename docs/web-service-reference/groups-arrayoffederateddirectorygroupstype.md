...
---
# <a name="groups-arrayoffederateddirectorygroupstype"></a>Gruppen (ArrayOfFederatedDirectoryGroupsType)

Das Element **Groups (ArrayOfFederatedDirectoryGroupsType)** ist nur zur internen Verwendung vorgesehen. 
