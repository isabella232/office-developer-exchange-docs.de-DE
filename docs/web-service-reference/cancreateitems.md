...
Der Textwert **true** gibt an, dass der Benutzer Elemente im Ordner erstellt werden kann. Der Wert **false** gibt an, dass der Benutzer nicht Elemente im Ordner erstellen kann. 
