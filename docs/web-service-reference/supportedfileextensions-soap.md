...
Das **SupportedFileExtensions** -Element enthält die Dateierweiterungen, die in einem Dokument sharing-Location gespeichert werden können. 
...
|:-----|:-----|
|[FileExtension (SOAP)](fileextension-soap.md) <br/> |Stellt eine Erweiterung dar.  <br/> |
