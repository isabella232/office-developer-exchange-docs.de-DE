...
Das **SupportedFileExtensions** -Element listet die Dateierweiterungen auf, die in einem Dokumentfreigabe Speicherort gespeichert werden können. 
...
|:-----|:-----|
|[Dateierweiterung (SOAP)](fileextension-soap.md) <br/> |Stellt eine Dateierweiterung dar.  <br/> |
