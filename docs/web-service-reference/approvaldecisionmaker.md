...
Das **ApprovalDecisionMaker** -Element gibt den Anzeigenamen der Person an, die die Genehmigungsentscheidung getroffen hat. 
...
Der Textwert des **ApprovalDecisionMaker** -Elements ist ein Anzeigename. 
