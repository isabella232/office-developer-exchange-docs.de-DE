...
ms.locfileid: "59544269"
---
# <a name="createfolderresponsemessage"></a>CreateFolderResponseMessage

Das **CreateFolderResponseMessage-Element** enthält den Status und das Ergebnis einer einzelnen [CreateFolder-Vorgangsanforderung.](createfolder-operation.md) 
...
|:-----|:-----|
|**ResponseClass** <br/> | Beschreibt den Status einer [CreateFolder-Vorgangsantwort.](createfolder-operation.md)<br/><br/>Die folgenden Werte sind für dieses Attribut gültig:<br/><br/>– Erfolg  <br/>- Warnung  <br/>- Fehler  <br/> |
...
|[Ordner](folders-ex15websvcsotherref.md) <br/> |Enthält ein Array von erstellten Ordnern.  <br/> |
