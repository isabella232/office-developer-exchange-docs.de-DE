...
Das **CreateItemResponseMessage** -Element enthält den Status und das Ergebnis einer einzelnen [CreateItem-Vorgangs](createitem-operation.md) Anforderung. 
...
|:-----|:-----|
|**ResponseClass** <br/> | Beschreibt den Status einer [CreateItem-Vorgangs](createitem-operation.md) Antwort.<br/><br/>Die folgenden Werte sind für dieses Attribut gültig:<br/><br/>-Success  <br/>-Warnung  <br/>-Error  <br/> |
...
|[Elemente](items.md) <br/> |Enthält ein Array erstellter Elemente.  <br/> |
