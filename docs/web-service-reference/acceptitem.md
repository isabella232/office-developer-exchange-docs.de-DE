...
Das **AcceptItem** -Element stellt eine Annahme Antwort auf eine Besprechungsanfrage dar. 
...
|[ProposedStart](proposedstart.md) <br/> |Gibt die vorgeschlagene Anfangszeit der Besprechung an.  <br/> |
...
Das Schema, das dieses Element beschreibt, befindet sich im EWS-Verzeichnis des Exchange-Servers, auf dem die Client Zugriffs-Serverrolle installiert ist.
