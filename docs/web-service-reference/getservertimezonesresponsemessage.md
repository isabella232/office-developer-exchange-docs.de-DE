...
ms.locfileid: "59509798"
---
# <a name="getservertimezonesresponsemessage"></a>GetServerTimeZonesResponseMessage

Das **GetServerTimeZonesResponseMessage-Element** enthält den Status und das Ergebnis einer einzelnen [GetServerTimeZones-Vorgangsanforderung.](getservertimezones-operation.md) 
