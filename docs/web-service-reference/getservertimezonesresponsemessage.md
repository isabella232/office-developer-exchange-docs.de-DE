...
Das **GetServerTimeZonesResponseMessage** -Element enthält den Status und das Ergebnis einer einzelnen [GetServerTimeZones-Vorgangs](getservertimezones-operation.md) Anforderung. 
