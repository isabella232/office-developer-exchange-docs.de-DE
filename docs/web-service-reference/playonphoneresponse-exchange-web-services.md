...
Das **PlayOnPhoneResponse** -Element gibt die Antwort auf eine Anforderung an eine Voicemail über das Telefon abgespielt werden soll. 
...
|[PhoneCallId](phonecallid.md) <br/> |Gibt den Bezeichner entgegengenommen wurde.  <br/> |
