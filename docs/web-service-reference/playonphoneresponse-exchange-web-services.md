...
description: Das PlayOnPhoneResponse-Element gibt die Antwort auf eine Anforderung zum Wiedergeben einer Voicemail über das Telefon an.
ms.openlocfilehash: f00dba0773eff6c992f014425d481dd83ff41e24
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: de-DE
ms.lasthandoff: 09/24/2021
ms.locfileid: "59543128"
---
# <a name="playonphoneresponse-exchange-web-services"></a>PlayOnPhoneResponse (Exchange-Webdienste)

Das **PlayOnPhoneResponse-Element** gibt die Antwort auf eine Anforderung zum Wiedergeben einer Voicemail über das Telefon an. 
...
|[PhoneCallId](phonecallid.md) <br/> |Gibt die Telefonanruf-ID an.  <br/> |
