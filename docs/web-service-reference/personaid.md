...
Das **PersonaId** -Element gibt den Persona-Bezeichner für den zugeordneten Rolle. 
...
|ChangeKey  <br/> |Der Textwert des **ChangeKey** -Attributs ist der Key Ändern der Rolle.  <br/> |
