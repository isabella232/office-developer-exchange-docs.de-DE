...
Das **AppendToFolderField** -Element ist nicht implementiert. Bei jeder Anforderung, die dieses Element verwendet, wird immer eine Fehlerantwort zurückgegeben. 
