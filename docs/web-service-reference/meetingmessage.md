...
description: Das MeetingMessage-Element stellt eine Besprechung im Exchange Speicher dar.
...
Das **MeetingMessage-Element** stellt eine Besprechung im Exchange Store dar. 
