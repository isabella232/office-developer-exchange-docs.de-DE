...
Das **OriginalStart** -Element darstellt, die ursprüngliche Anfangszeit der ein Kalenderelement. 
...
|:-----|:-----|
|[CalendarItem](calendaritem.md) <br/> |Stellt ein Kalenderelement im Exchange-Speicher.  <br/> |
