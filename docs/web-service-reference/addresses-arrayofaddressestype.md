...
---
# <a name="addresses-arrayofaddressestype"></a>Adressen (ArrayOfAddressesType)

Das **addresses** -Element gibt ein Array von **Address** -Elementen an. 
...
|:-----|:-----|
|[Address (ContactType)](address-contacttype.md) <br/> |Gibt die Adresse eines Kontakts an.  <br/> |
