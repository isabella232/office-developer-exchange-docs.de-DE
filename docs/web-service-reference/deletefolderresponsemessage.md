...
ms.locfileid: "59542456"
---
# <a name="deletefolderresponsemessage"></a>DeleteFolderResponseMessage

Das **DeleteFolderResponseMessage-Element** enthält den Status und das Ergebnis einer einzelnen [DeleteFolder-Vorgangsanforderung.](deletefolder-operation.md) 
...
|:-----|:-----|
|**ResponseClass** <br/> | Beschreibt den Status einer [DeleteFolder-Vorgangsantwort.](deletefolder-operation.md)<br/><br/>Die folgenden Werte sind für dieses Attribut gültig:<br/><br/>– Erfolg  <br/>- Warnung  <br/>- Fehler  <br/> |
