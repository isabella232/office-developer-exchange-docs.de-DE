...
Das **UniqueHash** -Element gibt einen eindeutigen Hashwert für Deduplizierung verwendet. 
...
Der Textwert der **UniqueHash** -Element ist ein Hashwert, der für die Deduplizierung. 
