...
Das **TooBigGroupAttendeeConflictData** -Element stellt einen Teilnehmer, der als Verteilerliste aufgelöst wurde, aber die Verteilerliste war zu groß, um zu erweitern. 
...
Verteilerlisten mit mehr als 100 Mitgliedern können nicht erweitert werden.
