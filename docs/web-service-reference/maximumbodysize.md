...
Das **MaximumBodySize** -Element gibt die maximale Größe der Textkörper des Elements in einer Antwort zurückgegeben. 
...
Der Textwert der **MaximumBodySize** -Element gibt die maximale Größe der [Body](body.md) -Eigenschaft in der Antwort zurückgegeben. Dies wird in Kilobyte gemessen. 
