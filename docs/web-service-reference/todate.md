...
Das **ToDate** -Element gibt das Datum, an dem die Nachricht empfangen wurde. 
...
Der Textwert der **ToDate** -Element ist das Datum, an das die Nachricht empfangen wurde. 
