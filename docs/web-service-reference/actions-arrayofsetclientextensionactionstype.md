...
---
# <a name="actions-arrayofsetclientextensionactionstype"></a>Aktionen (ArrayOfSetClientExtensionActionsType)

Das **Actions** -Element gibt ein Array von Aktionen für eine Client-Erweiterung ausführen. 
...
[Aktion (SetClientExtensionActionType)](action-setclientextensionactiontype.md)
