...
---
# <a name="isumenabledresponse-um-web-service"></a>IsUMEnabledResponse (um-Webdienst)

Das **IsUMEnabledResponse** -Element definiert eine Antwort auf eine Anforderung des [IsUMEnabled-Vorgangs (um-Webdienst)](isumenabled-operation-um-web-service.md) . 
