...
Das **ReminderNextTime** -Element gibt das Datum und die Uhrzeit für die nächste Erinnerung an. 
...
Der Textwert für das **ReminderNextTime** -Element ist das Datum und die Uhrzeit der nächsten geplanten Erinnerung. 
