...
---
# <a name="searchid"></a>Suchtaste

Das **Search** -ID-Element gibt den Bezeichner einer Ermittlungs Suche an. 
...
Der Textwert des **Search** -ID-Elements ist der Bezeichner der Ermittlungs Suche. 
