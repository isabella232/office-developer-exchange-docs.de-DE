...
---
# <a name="searchid"></a>Such

Das **Such** -Element gibt den Bezeichner der eine discoverysuche. 
...
Der Textwert des **Such** -Elements ist der Bezeichner der Discovery-Suche. 
