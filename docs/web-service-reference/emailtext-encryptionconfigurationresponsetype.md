...
---
# <a name="emailtext-encryptionconfigurationresponsetype"></a>EmailText fest (EncryptionConfigurationResponseType)

Das Element **emailText fest (EncryptionConfigurationResponseType)** ist nur zur internen Verwendung vorgesehen. 
