...
Das **DirectReports** -Element enthält die SMTP-Informationen, die die direkten Vorgesetzten eines Kontakts zu identifizieren. 
...
|:-----|:-----|
|[Kontaktperson](contact.md) <br/> |Stellt Kontakt im Exchange-Speicher.  <br/> |
