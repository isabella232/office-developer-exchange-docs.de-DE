...
---
# <a name="grouptype-mastermailboxtype"></a>GroupType (Master Mailbox Type)

Das **GroupType (Master Mailbox Type)-** Element ist nur für die interne Verwendung vorgesehen. 
