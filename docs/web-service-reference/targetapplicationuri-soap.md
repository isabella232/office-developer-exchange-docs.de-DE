...
Das **TargetApplicationUri** -Element definiert die URI-Zielanwendung. Das **TargetApplicationUri** -Element ist nur zur internen Verwendung. Dieses Element wird von Clients nicht verwendet. 
