...
Das [ConflictResults](conflictresults.md) -Element enthält die Anzahl der Konflikte in einer Antwort [UpdateItem Vorgang](updateitem-operation.md) . 
...
|:-----|:-----|
|[Count](count.md) <br/> |Enthält die Anzahl der Konflikte in einer Antwort [UpdateItem Vorgang](updateitem-operation.md) .  <br/> |
