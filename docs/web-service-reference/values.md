...
**Values** -Element enthält eine Auflistung von Werten für eine erweiterte Eigenschaft. 
...
|:-----|:-----|
|[Value](value.md) <br/> |Enthält einen Wert einer erweiterten Eigenschaft.  <br/> |
