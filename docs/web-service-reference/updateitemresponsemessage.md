...
ms.locfileid: "59538590"
---
# <a name="updateitemresponsemessage"></a>UpdateItemResponseMessage

Das **UpdateItemResponseMessage-Element** enthält den Status und das Ergebnis einer einzelnen [UpdateItem-Vorgangsanforderung.](updateitem-operation.md) 
...
|:-----|:-----|
|**ResponseClass** <br/> | Beschreibt den Status einer [UpdateItem-Vorgangsantwort.](updateitem-operation.md) <br/><br/>Die folgenden Werte sind für dieses Attribut gültig:  <br/><br/>– Erfolg  <br/>- Warnung  <br/>- Fehler  <br/> |
...
|[ConflictResults](conflictresults.md) <br/> |Enthält die Anzahl der Konflikte in einer [UpdateItem-Vorgangsantwort.](updateitem-operation.md)  <br/> |
