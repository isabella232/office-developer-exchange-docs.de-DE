...
Das **ProposeNewTime** -Element gibt eine Antwortobjekt, der angibt, dass der Besprechungsteilnehmer eine neue Besprechungszeit vorschlagen kann. 
...
|:-----|:-----|
|Objektname  <br/> |Der Name der im Response-Objekt.  <br/> |
