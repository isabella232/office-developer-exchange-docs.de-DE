...
Das **Absender** -Element identifiziert den Absender eines Elements. 
...
|:-----|:-----|
|[Postfach](mailbox.md) <br/> |Identifiziert ein e-Mail-aktivierte Active Directory-Objekt, das den Absender identifiziert.  <br/> |
