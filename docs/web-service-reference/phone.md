...
Das **Telefon** -Element gibt eine einzelne Telefonnummer ein, die aus einem Kontakt entitätenextraktion ergibt. 
...
["Originalphonestring"](originalphonestring.md) | ["phonestring"](phonestring.md) | [Typs (Zeichenfolge)](type-string.md)
