...
Das **GlobalFlagStatus** -Element enthält den aggregierten Kennzeichnungsstatus für alle Unterhaltungselemente in einem Postfach. 
...
Der Textwert des **GlobalFlagStatus** -Elements ist die aggregierten Kennzeichnungsstatus Unterhaltungselementen im aktuellen Ordner. Im folgenden sind die möglichen Textwerte: 
  
- **NotFlagged** - gibt den Status wird nicht gekennzeichnet. 
    
- **Flagged** - gibt den gekennzeichneten Status. 
    
- **Complete** – gibt die vollständige Kennzeichnungsstatus an. 
