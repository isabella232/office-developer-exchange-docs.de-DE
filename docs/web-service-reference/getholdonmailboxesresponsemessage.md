...
Das **GetHoldOnMailboxesResponseMessage** -Element gibt die Antwortnachricht für eine Anforderung **GetHoldOnMailboxes** . 
...
|:-----|:-----|
|[MailboxHoldResult](mailboxholdresult.md) <br/> |Das Ergebnis der Anforderung **GetHoldOnMailboxes** enthält.  <br/> |
