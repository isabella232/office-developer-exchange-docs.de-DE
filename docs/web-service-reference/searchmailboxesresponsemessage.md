...
Das **SearchMailboxesResponseMessage** -Element gibt die Antwortnachricht für eine **SearchMailboxes** -Anforderung an. 
...
[MessageText](messagetext.md)  |  [Response Code](responsecode.md)  |  [DescriptiveLinkKey](descriptivelinkkey.md)  |  [Messagexml verwendet](messagexml.md)  |  [SearchMailboxesResult](searchmailboxesresult.md)
