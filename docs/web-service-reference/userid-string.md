...
---
# <a name="userid-string"></a>Benutzer-ID (Zeichenfolge)

**UserId** -Element gibt die Benutzer-ID eines e-Mail-Benutzers an. 
...
Der Textwert der **UserId** -Element ist ein Bezeichner eines e-Mail-Benutzers. 
