...
ms.locfileid: "59545447"
---
# <a name="deleteattachmentresponsemessage"></a>DeleteAttachmentResponseMessage

Das **DeleteAttachmentResponseMessage-Element** enthält den Status und das Ergebnis einer einzelnen [DeleteAttachment-Vorgangsanforderung.](deleteattachment-operation.md) 
...
|:-----|:-----|
|**ResponseClass** <br/> | Beschreibt den Status einer [DeleteAttachment-Vorgangsantwort.](deleteattachment-operation.md)<br/><br/>Die folgenden Werte sind für dieses Attribut gültig:<br/><br/>– Erfolg  <br/>- Warnung  <br/>- Fehler  <br/> |
...
|[RootItemId](rootitemid.md) <br/> |Identifiziert das übergeordnete Element einer gelöschten Anlage.  <br/> |
