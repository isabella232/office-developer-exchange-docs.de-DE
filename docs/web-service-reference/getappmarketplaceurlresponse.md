...
ms.locfileid: "59530002"
---
# <a name="getappmarketplaceurlresponse"></a>GetAppMarketplaceUrlResponse

Das **GetAppMarketplaceUrlResponse-Element** gibt die Antwort auf eine **GetAppMarketplaceUrl-Anforderung** an. 
...
|:-----|:-----|
|[AppMarketplaceUrl](appmarketplaceurl.md) <br/> |Gibt die URL für die App an.  <br/> |
