...
Das **GetAppMarketplaceUrlResponse** -Element gibt die Antwort auf eine **GetAppMarketplaceUrl** an. 
...
|:-----|:-----|
|[AppMarketplaceUrl](appmarketplaceurl.md) <br/> |Gibt die URL für die app.  <br/> |
