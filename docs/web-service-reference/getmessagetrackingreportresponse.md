...
|[Diagnose](diagnostics.md) <br/> |Enthält Informationen zu Timing und Leistung, die für die Berichterstellung in einem Datencenter verwendet werden.  <br/> |
