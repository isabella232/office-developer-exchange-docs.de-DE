...
Das **CreatedTime** -Element gibt die Zeit, in der das Element erstellt wurde. 
...
Der Textwert des CreatedTime-Elements ist die Zeit, in der das Element erstellt wurde. 
