...
|**Element**|**Beschreibung**|
|:-----|:-----|
|[GetUserAvailabilityResponse](getuseravailabilityresponse.md) <br/> |Enthält die Eigenschaften, mit denen Benutzer Verfügbarkeitsinformationen oder vorgeschlagene Besprechungszeit Informationen definiert werden.  <br/> Für dieses Element wird folgender XPath-Ausdruck verwendet:   <br/>  `/GetUserAvailabilityResponse` <br/> |
