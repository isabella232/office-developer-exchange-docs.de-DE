...
Das **FindPeopleResponse** -Element gibt die Antwort auf eine **FindPeople** -Anforderung an. 
...
|:-----|:-----|
|[Personen](people.md) <br/> |Gibt ein Array von Persona-Daten an, die als Ergebnis einer **FindPeople** -Anforderung zurückgegeben werden.  <br/> |
|[TotalNumberOfPeopleInView](totalnumberofpeopleinview.md) <br/> |Gibt die Gesamtzahl der auf einem Server gespeicherten Personen an, die von einer **FindPeople** -Anforderung zurückgegeben werden.  <br/> |
