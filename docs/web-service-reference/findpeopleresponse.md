...
|[TotalNumberOfPeopleInView](totalnumberofpeopleinview.md) <br/> |Gibt die Gesamtzahl der auf einem Server gespeicherten Personas an, die von einer **FindPeople-Anforderung** zurückgegeben werden.  <br/> |
