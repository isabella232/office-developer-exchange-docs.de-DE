...
Das **MailTipsAccessEnabled** -Element darstellt, das **MailTipsAccessEnabled()** -Flag. Das **MailTipsAccessEnabled** -Element ist nur zur internen Verwendung. Dieses Element wird von Clients nicht verwendet. 
