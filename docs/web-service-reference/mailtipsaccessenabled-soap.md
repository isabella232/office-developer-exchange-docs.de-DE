...
Das **MailTipsAccessEnabled** -Element stellt das **MailTipsAccessEnabled ()** -Flag dar. Das **MailTipsAccessEnabled** -Element ist nur für die interne Verwendung. Dieses Element wird nicht von Clients verwendet. 
