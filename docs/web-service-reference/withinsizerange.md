...
Das **WithinSizeRange** -Element gibt die minimale und maximale Größe, die eingehende Nachrichten in der Reihenfolge für die Bedingung oder Ausnahme angewendet werden müssen. 
...
|:-----|:-----|
|[MinimumSize](minimumsize.md) <br/> |Gibt die minimale Größe, die eine Nachricht in der Reihenfolge für die Bedingung oder Ausnahme angewendet werden muss.  <br/> |
|[Max](maximumsize.md) <br/> |Gibt die maximale Größe, die eine Nachricht in der Reihenfolge für die Bedingung oder Ausnahme angewendet werden muss.  <br/> |
