...
Das **PhoneticFirstName** -Element enthält den Vornamen eines Kontakts phonetisch geschrieben. 
...
Der Textwert ist eine Zeichenfolge, die den Vornamen eines Kontakts phonetisch geschrieben.
