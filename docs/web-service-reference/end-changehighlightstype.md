...
Das **Ende** -Element gibt die Änderungen an einer Besprechung Endzeit, wenn eine besprechungsaktualisierung auftritt. 
...
Der Textwert der **End** -Element ist die neue Endzeit einer Besprechung. 
