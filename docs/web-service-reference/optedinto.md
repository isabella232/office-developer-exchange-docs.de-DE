...
Das **OptedInto** -Element gibt einen Boolean-Wert, der angibt, ob der Benutzer in der Aufbewahrungsrichtlinie bestätigt. 
...
Der Textwert **true** für das **OptedInto** -Element gibt an, dass der Benutzer in der Aufbewahrungsrichtlinie bestätigt. Der Wert **false** gibt an, dass der Benutzer nicht in der Aufbewahrungsrichtlinie opt. 
