...
ms.locfileid: "59536308"
---
# <a name="createmanagedfolderresponsemessage"></a>CreateManagedFolderResponseMessage

Das **CreateManagedFolderResponseMessage-Element** enthält den Status und das Ergebnis einer einzelnen [CreateManagedFolder-Vorgangsanforderung.](createmanagedfolder-operation.md) 
...
|:-----|:-----|
|**ResponseClass** <br/> | Beschreibt den Status einer [CreateManagedFolder-Vorgangsantwort.](createmanagedfolder-operation.md)<br/><br/>Die folgenden Werte sind für dieses Attribut gültig:<br/><br/>– Erfolg  <br/>- Warnung  <br/>- Fehler  <br/> |
...
|[Ordner](folders-ex15websvcsotherref.md) <br/> |Enthält ein Array von erstellten verwalteten Ordnern.  <br/> |
