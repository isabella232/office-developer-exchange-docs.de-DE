...
Das **DisplayNamePrefix** -Element gibt das Präfix des Anzeigenamens der zugeordneten persona an. 
...
Der Textwert des **DisplayNamePrefix** -Elements ist ein String-Wert, der das Präfix für den Anzeigenamen angibt. 
