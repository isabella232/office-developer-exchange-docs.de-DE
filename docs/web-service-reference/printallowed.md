...
Das **PrintAllowed** -Element gibt an, ob Drucken aktiviert ist. 
...
Der Textwert **true** für das **PrintAllowed** -Element gibt an, dass der Inhalt drucken für ein Element Rechte verwaltet zulässig ist. Der Wert **false** gibt an, dass Drucken nicht zulässig ist. 
