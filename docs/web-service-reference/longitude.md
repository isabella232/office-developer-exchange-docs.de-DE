...
Das **Längengrad** -Element gibt die Länge des Speicherorts für die zugeordnete Postanschrift. 
...
Der Textwert des **Längengrad** -Elements ist die Länge der Postadresse Koordinaten. 
