...
Das Element **ContactId** identifiziert eindeutig einen Kontakt. 
...
|:-----|:-----|
|Id  <br/> |Der Textwert des **Id** -Attributs ist der Bezeichner des Kontaktelements.  <br/> |
|ChangeKey  <br/> |Der Textwert des **ChangeKey** -Attributs ist der Key ändern des Kontaktelements.  <br/> |
