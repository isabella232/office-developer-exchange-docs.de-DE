...
Das **ContactId** Contacts-Element identifiziert einen Kontakt eindeutig. 
...
|:-----|:-----|
|Id  <br/> |Der Textwert des **ID-** Attributs ist die ID des Kontaktelements.  <br/> |
|ChangeKey  <br/> |Der Textwert des **ChangeKey** -Attributs ist der Änderungsschlüssel des Kontaktelements.  <br/> |
