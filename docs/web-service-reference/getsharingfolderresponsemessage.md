...
ms.locfileid: "59515831"
---
# <a name="getsharingfolderresponsemessage"></a>GetSharingFolderResponseMessage

Das **GetSharingFolderResponseMessage-Element** enthält den Status und das Ergebnis einer einzelnen [GetSharingFolder-Vorgangsanforderung.](getsharingfolder-operation.md) 
