...
Das **SentTime** -Element gibt die Zeit, zu der das Element gesendet wurde. 
...
Der Textwert des **SentTime** -Elements ist das Datum und die Uhrzeit, wann ein Element gesendet wurde. 
