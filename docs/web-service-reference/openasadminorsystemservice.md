...
Das **OpenAsAdminOrSystemService** -Element ist nur zur internen Verwendung. Dieses Element wird von Clients nicht verwendet. 
...
|:-----|:-----|
|LogonType  <br/> |Nicht für die Verwendung durch Clients vorgesehen.  <br/> |
   
### <a name="child-elements"></a>Untergeordnete Elemente

|**Element**|**Beschreibung**|
|:-----|:-----|
|ConnectingSID  <br/> |Nicht für die Verwendung durch Clients vorgesehen.  <br/> |
