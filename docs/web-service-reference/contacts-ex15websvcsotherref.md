...
**Kontakte** -Element enthält eine Liste von Kontakten, die mit einem Vorgang verknüpft sind. 
...
|:-----|:-----|
|[String](string.md) <br/> |Stellt eine durch Trennzeichen getrennte Liste mit Kontaktnamen.  <br/> |
