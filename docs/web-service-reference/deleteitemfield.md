...
|**Element**|**Beschreibung**|
|:-----|:-----|
|[Updates (Element)](updates-item.md) <br/> |Enthält einen Satz von Elementen, die Änderungen an Elementeigenschaften definieren, festlegen und löschen.  <br/><br/>Für dieses Element wird folgender XPath-Ausdruck verwendet: <br/>`/UpdateItem/ItemChanges/ItemChange[i]/Updates` <br/> |
