...
Das **Generation** -Element darstellt, die den vollständigen Namen eines Kontakts bildet Abkürzung für eine generationsbasierten. 
...
Dieses Element stellt dieselbe Informationen, die durch die PR_Generation MAPI-Eigenschaft dargestellt wird.
