...
ms.locfileid: "59539437"
---
# <a name="ismeetingrequest"></a>IsMeetingRequest

Das **IsMeetngRequest-Element** gibt an, ob eingehende Nachrichten eine Besprechungsanfrage sein müssen, damit die Bedingung oder Ausnahme zutrifft. 
...
Der Textwert **"true"** gibt an, dass die Nachricht eine Besprechungsanfrage sein muss, damit die Bedingung oder Ausnahme zutrifft. Der Wert **"false"** gibt an, dass die Nachricht keine Besprechungsanfrage sein darf, damit die Bedingung oder Ausnahme zutrifft. 
