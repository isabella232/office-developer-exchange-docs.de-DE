...
Das **ImTelephoneNumber** -Element darstellt, die Telefonnummer für einen Kontakt, der die ein Instant messaging (IM)-Gruppe hinzugefügt wird. 
...
Der Textwert des **ImTelephoneNumber** -Elements ist die Telefonnummer eines Kontakts an. 
