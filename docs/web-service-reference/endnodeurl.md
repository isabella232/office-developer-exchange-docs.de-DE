...
Das **EndNodeUrl** -Element gibt die URL für die Mail-App im Office Store an. 
...
Der Textwert des **EndNodeUrl** -Elements ist die URL für die Mail-app in der Office Store. 
