...
Das **Lesen** -Element gibt an, ob ein Client eines Ordners oder Element lesen kann. Dieses Element wurde in Microsoft Exchange Server 2007 Service Pack 1 (SP1) eingeführt. 
