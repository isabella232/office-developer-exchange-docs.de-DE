...
---
# <a name="calendarurl-mastermailboxtype"></a>CalendarUrl (Master Mailbox Type)

Das **CalendarUrl (Master Mailbox Type)-** Element ist nur für die interne Verwendung vorgesehen. 
