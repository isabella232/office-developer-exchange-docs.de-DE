...
Das **NumberedRecurrence** -Element beschreibt das Startdatum und die Anzahl der Vorkommen eines wiederkehrenden Elements. 
...
|[NumberOfOccurrences](numberofoccurrences.md) <br/> |Enthält die Anzahl der Vorkommen eines wiederkehrenden Elements.  <br/> |
