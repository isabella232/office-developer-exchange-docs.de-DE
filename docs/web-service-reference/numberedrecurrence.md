...
Das **NumberedRecurrence** -Element wird das Startdatum und die Anzahl der Vorkommen eines sich wiederholenden-Elements beschrieben. 
...
|[NumberOfOccurrences](numberofoccurrences.md) <br/> |Enthält die Anzahl der Vorkommen eines sich wiederholenden-Elements an.  <br/> |
