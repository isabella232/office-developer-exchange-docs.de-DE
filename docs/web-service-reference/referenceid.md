...
Das **Reference** -ID-Element gibt den Referenzbezeichner für das Postfach an. 
...
Der Textwert des **Reference** -ID-Elements ist der Referenzbezeichner eines Postfachs. 
