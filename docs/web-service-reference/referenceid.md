...
Das **ReferenceId** -Element gibt den Verweisbezeichner für das Postfach an. 
...
Der Textwert der **ReferenceId** -Element ist der Verweisbezeichner eines Postfachs an. 
