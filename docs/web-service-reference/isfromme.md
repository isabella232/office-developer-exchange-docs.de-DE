...
Das **IsFromMe** -Element gibt an, ob ein Benutzer ein Element an sich gesendet. 
...
Der Textwert **true** gibt an, dass das Element an sich von einem Benutzer gesendet wurde. Der Wert **false** gibt an, dass das Element an sich nicht durch den Benutzer gesendet wurde. 
