...
**ReceivedTime** -Element gibt die Zeit, zu der ein Element empfangen wurde. 
...
Der Textwert der **ReceivedTime** -Element ist das Datum und die Uhrzeit, die ein Element empfangen wurde. 
