...
---
# <a name="address-contacttype"></a>Adresse (Kontakttyp den)

Das **Address** -Element gibt die Adresse eines Kontakts. 
...
Der Textwert der **Address** -Element ist die Adresse des Kontakts. 
