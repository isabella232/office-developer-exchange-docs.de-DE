...
Das **LastModifiedName** -Element enthält den Anzeigenamen des Benutzers auf ein Element zu ändern. Dieses Element ist schreibgeschützt. Dieses Element wurde in Microsoft Exchange Server 2007 Service Pack 1 (SP1) eingeführt. 
...
Der Textwert ist ein Zeichenfolgenwert, der den Anzeigenamen des Benutzers so ändern Sie das Element darstellt.
