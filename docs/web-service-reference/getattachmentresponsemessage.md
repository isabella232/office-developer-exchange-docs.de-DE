...
Das **GetAttachmentResponseMessage** -Element enthält, der Status und das Ergebnis einer einzelnen Anforderung [-Vorgangs GetAttachment](getattachment-operation.md) . 
...
|:-----|:-----|
|**ResponseClass** <br/> | Beschreibt den Status des [Vorgangs GetAttachment](getattachment-operation.md) Antwort.<br/><br/> Die folgenden Werte sind für dieses Attribut gültig: <br/> <br/>-Success  <br/>-Warnung  <br/>-Fehler  <br/> |
...
|[Anlagen](attachments-ex15websvcsotherref.md) <br/> |Enthält die Elemente oder Dateien, die auf ein Element in der Exchange-Speicher Ttached sind.  <br/> |
