...
Das **SortValue** -Element gibt einen Wert für die Sortierung verwendet. 
...
Der Textwert des [SortValue](sortvalue.md) -Elements ist das zum Sortieren des Resultsets dar. 
