...
Das **ExternalEmailAddress** -Element enthält die externe e-Mail-Adresse des Postfachs an. 
...
Der Textwert des **ExternalEmailAddress** -Elements ist die externe e-Mail-Adresse des Postfachs an. 
