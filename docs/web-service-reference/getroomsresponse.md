...
ms.openlocfilehash: 88d5d21ddbfa17b3869a49203c9d2187744eacb0
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: de-DE
ms.lasthandoff: 09/24/2021
ms.locfileid: "59539950"
---
# <a name="getroomsresponse"></a>GetRoomsResponse

Das **GetRoomsResponse-Element** definiert eine Antwort auf eine [GetRooms-Vorgangsanforderung.](getrooms-operation.md) 
...
|**Error** <br/> | Beschreibt eine Anforderung, die nicht erfüllt werden kann. <br/><br/>Es folgen Beispiele für Fehlerquellen:  <br/><br/>– Ungültige Attribute oder Elemente  <br/>– Attribute oder Elemente außerhalb des Bereichs  <br/>– Ein unbekanntes Tag  <br/>– Ein Attribut oder Element, das im Kontext ungültig ist  <br/>– Ein nicht autorisierter Zugriffsversuch durch einen beliebigen Client  <br/>– Ein serverseitiger Fehler als Reaktion auf einen gültigen clientseitigen Anruf  <br/><br/>  Informationen zu dem Fehler finden Sie in den [ResponseCode-](responsecode.md) und [MessageText-Elementen.](messagetext.md)  <br/> |
...
|[Räume](rooms.md) <br/> |Stellt eine Liste von E-Mail-Adressen und Anzeigenamen bereit, die Besprechungsräume darstellen.  <br/> |
