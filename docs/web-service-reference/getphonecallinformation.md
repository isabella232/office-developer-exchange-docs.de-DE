...
Das **GetPhoneCallInformation** -Element gibt eine Anforderung zum Abrufen von Informationen entgegengenommen wurde. 
...
|:-----|:-----|
|[PhoneCallId](phonecallid.md) <br/> |Gibt den Bezeichner eines Telefonanrufs.  <br/> |
