...
Das **SendItemResponseMessage-Element** enthält den Status und das Ergebnis einer einzelnen [SendItem-Vorgangsanforderung.](senditem-operation.md) 
...
|:-----|:-----|
|**ResponseClass** <br/> | Beschreibt den Status einer [SendItem-Vorgangsantwort.](senditem-operation.md) <br/><br/>Die folgenden Werte sind für dieses Attribut gültig: <br/> <br/>– Erfolg  <br/>- Warnung  <br/>- Fehler  <br/> |
