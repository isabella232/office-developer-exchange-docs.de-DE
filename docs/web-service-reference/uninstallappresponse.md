...
Das **UninstallAppResponse** -Element gibt die Antwort auf eine **UninstallApp** -Anforderung an. 
...
[Messagexml verwendet](messagexml.md)  |  [Response Code](responsecode.md)  |  [DescriptiveLinkKey](descriptivelinkkey.md)  |  [Messagexml verwendet](messagexml.md)
