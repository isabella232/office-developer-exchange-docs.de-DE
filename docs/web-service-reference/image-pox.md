...
Das **Image** -Element enthält den Pfad eines Bilds, das zum Branding der Konfigurationsumgebung verwendet wird. 
...
Der Textwert stellt den Pfad eines Bilds dar, das zum Branding der Konfigurationsumgebung verwendet wird.
