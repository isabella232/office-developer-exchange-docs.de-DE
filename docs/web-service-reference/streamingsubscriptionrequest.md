...
description: Das StreamingSubscriptionRequest-Element stellt ein Abonnement für ein Streamingereignisbenachrichtigungsabonnement dar.
...
Das **StreamingSubscriptionRequest-Element** stellt ein Abonnement für ein Streamingereignisbenachrichtigungsabonnement dar. 
...
|:-----|:-----|
|**SubscribeToAllFolders** <br/> |Gibt an, ob der Server alle Ordner im Postfach des Benutzers abonniert. Der Wert **"true"** gibt an, dass der Server abonniert.  <br/> |
