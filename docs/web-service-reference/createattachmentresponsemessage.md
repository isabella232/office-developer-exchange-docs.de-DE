...
Das **CreateAttachmentResponseMessage** -Element enthält den Status und das Ergebnis einer einzelnen [CreateAttachment-Vorgangs](createattachment-operation.md) Anforderung. 
...
|:-----|:-----|
|**ResponseClass** <br/> | Beschreibt den Status einer [CreateAttachment-Vorgangs](createattachment-operation.md) Antwort. <br/><br/>Die folgenden Werte sind für dieses Attribut gültig:<br/><br/>-Success  <br/>-Warnung  <br/>-Error  <br/> |
...
> [!NOTE]
> Wenn mehrere Anlagen an ein Element in einem einzelnen Roundtrip angefügt werden, ist das **RootItemChangeKey** -Attribut in der letzten Antwortnachricht diejenige, die den neuen Änderungsschlüssel des Elements darstellt, das die Anlagen enthält. 
