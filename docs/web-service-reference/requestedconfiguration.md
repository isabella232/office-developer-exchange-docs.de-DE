...
Das **RequestedConfiguration** -Element enthält die Konfigurationen für den angeforderten Dienst. 
...
|:-----|:-----|
|[ConfigurationName](configurationname.md) <br/> |Gibt den Namen der angeforderten Dienstkonfigurationen an.  <br/> |
