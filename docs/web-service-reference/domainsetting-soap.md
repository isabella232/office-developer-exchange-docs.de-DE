...
Das **DomainSetting** -Element enthält die domäneneinstellungen für die, die von der [GetDomainSettings-Vorgang (SOAP)](getdomainsettings-operation-soap.md) Vorgang Anforderung zurückgegeben werden. 
