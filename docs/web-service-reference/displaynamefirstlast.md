...
Das **DisplayNameFirstLast** -Element gibt den Anzeigenamen der zugeordneten Persona im Format "First Name", "Nachname" an. 
...
Der Textwert des **DisplayNameFirstLast** -Elements ist ein String-Wert, der den Anzeigenamen mit dem angegebenen Namen zuerst enthält. 
