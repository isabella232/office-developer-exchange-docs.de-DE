...
Das **PageItemSize** -Element gibt die Anzahl der Elemente, die in eine Suche Ergebnis Paginierung zurückgegeben. 
...
Der Textwert des **PageItemSize** -Elements ist die Anzahl der Elemente, die in eine Suche Ergebnis Paginierung zurückgegeben. 
