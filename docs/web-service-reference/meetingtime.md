...
Das **MeetingTime** -Element stellt eine vorgeschlagene Besprechungszeitraum dar. 
...
Das [MeetingTime](meetingtime.md) -Element ist ein erforderliches untergeordnetes Element des Elements [Vorschlag](suggestion.md) . 
