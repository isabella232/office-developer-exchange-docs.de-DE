...
description: Das DictionaryEntry-Element gibt den Inhalt einer einzelnen Wörterbucheintragseigenschaft an.
...
Das **DictionaryEntry-Element** gibt den Inhalt einer einzelnen Wörterbucheintragseigenschaft an. 
