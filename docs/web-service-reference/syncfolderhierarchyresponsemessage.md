...
Das **SyncFolderHierarchyResponseMessage** -Element enthält, der Status und das Ergebnis einer einzelnen Anforderung [SyncFolderHierarchy Vorgang](syncfolderhierarchy-operation.md) . 
...
|:-----|:-----|
|**ResponseClass** <br/> | Beschreibt den Status einer Antwort [SyncFolderHierarchy Vorgang](syncfolderhierarchy-operation.md) . <br/><br/>Die folgenden Werte sind für dieses Attribut gültig:<br/>  <br/>-Success  <br/>-Warnung  <br/>-Fehler  <br/> |
...
|[IncludesLastFolderInRange](includeslastfolderinrange.md) <br/> |Gibt an, ob das letzte Element synchronisieren in der Antwort aufgenommen wurde.  <br/> |
|[Änderungen (Hierarchie)](changes-hierarchy.md) <br/> |Enthält ein Array Sequenz von Dateitypen ändern, die die Typen der Unterschiede zwischen den Elementen auf dem Client und der Elemente auf dem Exchange-Server darstellen.  <br/> |
