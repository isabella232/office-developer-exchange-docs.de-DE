...
ms.locfileid: "59519478"
---
# <a name="isunmodified"></a>IsUnmodified

Das **IsUnmodified-Element** gibt an, ob das Element geändert wurde. 
...
Der Textwert **"true"** gibt an, dass das Element unverändert ist. Der Textwert **"false"** gibt an, dass das Element geändert wurde. 
