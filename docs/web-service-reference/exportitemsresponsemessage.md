...
Das **ExportItemsResponseMessage** -Element enthält den Status und die Ergebnisse einer Anforderung zum Exportieren eines einzelnen Post Fach Elements. 
...
|[ItemId](itemid.md) <br/> |Enthält den Elementbezeichner eines exportierten Elements.  <br/> |
|[Data (base64Binary)](data-base64binary.md) <br/> |Enthält den Inhalt eines exportierten Elements.  <br/> |
