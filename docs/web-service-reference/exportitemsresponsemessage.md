...
Das **ExportItemsResponseMessage** -Element enthält den Status und die Ergebnisse einer Anforderung für ein einzelnes Postfach-Element zu exportieren. 
...
|[ItemId](itemid.md) <br/> |Enthält die Element-ID eines Elements exportierten.  <br/> |
|[Daten (base64Binary)](data-base64binary.md) <br/> |Enthält den Inhalt eines exportierten Elements.  <br/> |
