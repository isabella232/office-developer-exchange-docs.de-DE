...
Der Textwert **true** für das **HasEndTimeChanged** -Element gibt an, dass die Zeit für das Ende einer Besprechung geändert wurde. Der Wert **false** gibt an, dass die Endzeit der Besprechung nicht geändert wurde. 
