...
Das **SendNotificationResponseMessage** -Element enthält den Status und das Ergebnis einer Anforderung **SendNotification** -Vorgang. 
...
|:-----|:-----|
|**ResponseClass** <br/> | Beschreibt den Status der Antwort eine **SendNotification** -Vorgang. <br/><br/>Die folgenden Werte sind für dieses Attribut gültig:  <br/><br/>-Success  <br/>-Warnung  <br/>-Fehler  <br/> |
...
|**Fehler** <br/> | Beschreibt eine Anforderung, die nicht gewährleistet werden kann. <br/><br/>Es folgen Beispiele für Datenquellen von Fehlern:  <br/><br/>-Ungültige Attribute oder Elemente  <br/>-Attribute oder Elemente, die sich außerhalb des gültigen Bereichs befinden.  <br/>-Eine unbekannte Marke  <br/>-Attribut oder ein Element, das nicht im Kontext gültig ist.  <br/>-Einen nicht autorisierten Zugriffsversuch von jedem client  <br/>-Eine serverseitige Fehler als Reaktion auf einen gültigen mithilfe der clientseitigen Anruf  <br/><br/>  Informationen zu dem Fehler kann in den Elementen [ResponseCode](responsecode.md) und [MessageText](messagetext.md) gefunden werden.  <br/> |
