...
description: Das ServiceConfigurationResponseMessageType-Element enthält Dienstkonfigurationseinstellungen.
...
Das **ServiceConfigurationResponseMessageType-Element** enthält Dienstkonfigurationseinstellungen. 
...
|**Error** <br/> | Beschreibt eine Anforderung, die nicht erfüllt werden kann. <br/><br/>Es folgen Beispiele für Fehlerquellen:  <br/><br/>– Ungültige Attribute oder Elemente  <br/>– Attribute oder Elemente, die außerhalb des Gültigen liegen  <br/>– Ein unbekanntes Tag  <br/>- Ein Attribut oder Element ist im Kontext ungültig  <br/>– Ein nicht autorisierter Zugriffsversuch durch einen beliebigen Client  <br/>– Ein serverseitiger Fehler als Reaktion auf einen gültigen clientseitigen Anruf  <br/><br/>  Informationen zu dem Fehler finden Sie in den [ResponseCode-](responsecode.md) und [MessageText-Elementen.](messagetext.md)  <br/> |
...
|**Element**|**Beschreibung**|
|:-----|:-----|
|[ResponseMessages (ArrayOfServiceConfigurationResponseMessageType)](responsemessages-arrayofserviceconfigurationresponsemessagetype.md) <br/> |Enthält ein Array von Antwortnachrichten zur Dienstkonfiguration.  <br/> |
