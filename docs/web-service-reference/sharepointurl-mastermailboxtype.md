...
---
# <a name="sharepointurl-mastermailboxtype"></a>SharePointUrl (Master Mailbox Type)

Das **SharePointUrl (Master Mailbox Type)-** Element ist nur für die interne Verwendung vorgesehen. 
