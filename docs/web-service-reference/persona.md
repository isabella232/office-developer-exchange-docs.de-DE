...
---
# <a name="persona"></a><span data-ttu-id="93ae7-103">Rolle</span><span class="sxs-lookup"><span data-stu-id="93ae7-103">Persona</span></span>

<span data-ttu-id="93ae7-104">Das **Persona** -Element gibt einen Satz von Persona Daten von einer Anforderung **GetPersona** zurückgegeben.</span><span class="sxs-lookup"><span data-stu-id="93ae7-104">The **Persona** element specifies a set of persona data returned by a **GetPersona** request.</span></span> 
