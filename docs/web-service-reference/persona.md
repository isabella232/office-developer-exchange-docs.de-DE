...
---
# <a name="persona"></a><span data-ttu-id="156f0-103">Persona</span><span class="sxs-lookup"><span data-stu-id="156f0-103">Persona</span></span>

<span data-ttu-id="156f0-104">Das **Persona** -Element gibt eine Gruppe von Persona-Daten an, die von einer **getpersona** -Anforderung zurückgegeben werden.</span><span class="sxs-lookup"><span data-stu-id="156f0-104">The **Persona** element specifies a set of persona data returned by a **GetPersona** request.</span></span> 
