...
description: Das CurrentMeetingTime-Element stellt die Startzeit einer Besprechung dar, die Sie mit einer von einem Besprechungsteilnehmer vorgeschlagenen Besprechungszeit aktualisieren möchten.
ms.openlocfilehash: ef208d232a376d3a7fcffc08db1b8864635c0d0a
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: de-DE
ms.lasthandoff: 09/24/2021
ms.locfileid: "59536155"
---
# <a name="currentmeetingtime"></a>CurrentMeetingTime

Das **CurrentMeetingTime-Element** stellt die Startzeit einer Besprechung dar, die Sie mit einer von einem Besprechungsteilnehmer vorgeschlagenen Besprechungszeit aktualisieren möchten. 
