...
Das **SetImGroup** -Element stellt eine Anforderung zum Ändern des Anzeigenamens einer Sofortnachrichten Gruppe dar. 
...
[Gruppen-Nr](groupid.md)  |  [Neuanzeigename](newdisplayname.md)
