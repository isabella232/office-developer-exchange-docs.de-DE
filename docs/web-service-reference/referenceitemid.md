...
description: Das ReferenceItemId-Element identifiziert das Element, auf das sich das Antwortobjekt bezieht.
ms.openlocfilehash: b6ddb59eb3f266aff6400429ac8178f5640bf06b
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: de-DE
ms.lasthandoff: 09/24/2021
ms.locfileid: "59542858"
---
# <a name="referenceitemid"></a>ReferenceItemId

Das **ReferenceItemId-Element** identifiziert das Element, auf das sich das Antwortobjekt bezieht. 
...
|**ChangeKey** <br/> |Identifiziert eine bestimmte Version eines Elements.  <br/> |
...
|[AcceptSharingInvitation](acceptsharinginvitation.md) <br/> |Stellt eine Accept-Antwort auf eine Freigabe-Einladung dar.  <br/> |
...
|[SuppressReadReceipt](suppressreadreceipt.md) <br/> |Wird verwendet, um auf Lesebestätigungsanforderungen zu reagieren.  <br/> |
