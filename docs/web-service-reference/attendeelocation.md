...
Das **AttendeeLocation** -Element gibt die Position eines Teilnehmers für ein Kalenderelement an. 
...
|:-----|:-----|
|[LocationBasedStateDefinition](locationbasedstatedefinition.md) <br/> |Gibt den Status an, wenn er auf dem Standort basiert.  <br/> |
   
## <a name="text-value"></a>Textwert

Der Textwert des AttendeeLocation-Elements ist der attendess-Speicherort.
