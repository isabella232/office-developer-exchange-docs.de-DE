...
Das **GlobalUniqueRecipients** -Element enthält die Empfängerliste einer Unterhaltung über ein Postfach aggregiert. 
...
|:-----|:-----|
|[String](string.md) <br/> |Einen einzelnen Gespräch Empfänger enthält.  <br/> |
