...
Das **StartTimeZoneId** -Element gibt die Zeitzone an, in der eine Besprechung stattfindet. 
...
Der Textwert des **StartTimeZoneId** -Elements ist der Zeitzonenbezeichner der Zeitzone, die im [Start](start.md) -Element verwendet wird. 
