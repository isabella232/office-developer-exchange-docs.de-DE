...
Das **MinorBuildNumber** -Element darstellt, minor Buildnummer für den Server. 
...
Ein Ganzzahlwert, der die Nebenversionsnummer darstellt Buildnummer des Servers, der die Anforderung verarbeitet.
