...
Das **PhoneNumberAttributedValue** -Element gibt eine Instanz des ein Array von Telefonnummern und deren zugeordneten Hinweise. 
...
[Wert (PersonaPhoneNumberType)](value-personaphonenumbertype.md) | [Marken (ArrayOfValueAttributionsType)](attributions-arrayofvalueattributionstype.md)
