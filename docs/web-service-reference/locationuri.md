...
Das **LocationUri** -Element enthält eine Zeichenfolge zur Angabe einer URI Uniform Resource Identifier () von der zugeordneten Postadresse. 
...
Der Textwert des **LocationUri** -Elements ist eine Zeichenfolge, die einen URI zu Informationen über eine Postadresse angibt. 
