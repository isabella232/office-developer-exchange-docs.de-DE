...
Das **Port** -Element stellt die Portnummer dar, die für das Protokoll verwendet werden soll. 
...
Der Wert ist die Portnummer, die für das Protokoll verwendet werden soll.
