...
Das Element **EventData** stellt Daten, die im Verarbeitungsschritt für das Ereignis zugeordnet ist. 
...
|:-----|:-----|
|[String](string.md) <br/> |Enthält eine Zeichenfolge zur Identifizierung ein Ereignisses.  <br/> |
