...
Das **ContainsSubjectStrings** -Element gibt an, die Zeichenfolgen, die den Betreff der eingehenden Nachrichten in der Reihenfolge für die Bedingung oder Ausnahme anzuwendende vorhanden sein müssen. 
...
|:-----|:-----|
|[String](string.md) <br/> |Stellt eine Zeichenfolge, die den Betreff der eingehenden Nachrichten in der Reihenfolge für die Bedingung oder Ausnahme anzuwendende vorhanden sein muss.  <br/> |
