...
Das **UploadItemsResponseMessage** -Element enthält den Status und die Ergebnisse einer Anforderung für ein einzelnes Postfach Element hochladen. 
...
|[ItemId](itemid.md) <br/> |Enthält die Element-ID eines Elements hochgeladenen.  <br/> |
