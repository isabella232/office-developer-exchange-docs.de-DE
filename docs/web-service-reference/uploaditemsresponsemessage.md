...
description: Das UploadItemsResponseMessage-Element enthält den Status und die Ergebnisse einer Anforderung zum Hochladen eines einzelnen Postfachelements.
ms.openlocfilehash: 8044950be1a891e20d97d988d8fca405f93d107e
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: de-DE
ms.lasthandoff: 09/24/2021
ms.locfileid: "59517399"
---
# <a name="uploaditemsresponsemessage"></a>UploadItemsResponseMessage

Das **UploadItemsResponseMessage-Element** enthält den Status und die Ergebnisse einer Anforderung zum Hochladen eines einzelnen Postfachelements. 
...
|[ItemId](itemid.md) <br/> |Enthält den Elementbezeichner eines hochgeladenen Elements.  <br/> |
