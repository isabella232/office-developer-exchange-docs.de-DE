...
Das **GetUserOofSettingsRequest** -Element ist das Stammelement mit den Argumenten verwendet, um ein Postfach des Benutzers Out of Office (OOF) Einstellungen abzurufen. 
...
Es folgt ein Beispiel für eine GetUserOofSettings-Anforderung, die Informationen für einen Einzelbenutzer OOF abruft.
