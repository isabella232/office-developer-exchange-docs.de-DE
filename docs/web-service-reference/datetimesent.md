...
Das **DateTimeSent** -Element darstellt, das Datum und die Uhrzeit, zu der ein Element in einem Postfach gesendet wurde. 
...
Der Textwert stellt Datum und Uhrzeit, zu der ein Element gesendet wurde.
