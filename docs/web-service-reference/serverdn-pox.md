...
Das **ServerDN** -Element gibt den distinguished Name des Computers, auf dem Microsoft Exchange Server 2007 ausgeführt wird. 
...
Der Textwert stellt den distinguished Name des Exchange-Servers.
  
## <a name="remarks"></a>Hinweise

Der Wert **ServerDN** wird nur verwendet, wenn [Type (POX)](type-pox.md) Wechselkurs entspricht 
