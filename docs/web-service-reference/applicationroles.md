...
Das **ApplicationRoles** -Element gibt die Rollen der Anwendung, die die aufrufende partneranwendung für den aktuellen Anruf verwendet. 
...
|:-----|:-----|
|[Role](role.md) <br/> |Gibt eine Zeichenfolge, die eine Verwaltungsrolle darstellt.  <br/> |
