...
**Subject** -Element stellt die Subject-Eigenschaft des Exchange-Speicher-Elementen. Der Betreff ist auf 255 Zeichen beschränkt. 
...
|[CancelCalendarItem](cancelcalendaritem.md) <br/> |Ein Abbrechen Kalender Element Response-Objekt darstellt.  <br/> |
...
|[ForwardItem](forwarditem.md) <br/> |Stellt ein Smarttag Antwortobjekt zur Weiterleitung von Elementen.  <br/> |
...
|[Message](message-ex15websvcsotherref.md) <br/> |Stellt eine E-mail im Exchange-Speicher.  <br/> |
...
|[RemoveItem](removeitem.md) <br/> |Stellt ein Elementobjekt Antwort entfernen.  <br/> |
|[ReplyAllToItem](replyalltoitem.md) <br/> |Ein smart von allen Antworten-Antwortobjekt darstellt.  <br/> |
|[ReplyToItem](replytoitem.md) <br/> |Ein smart Antwortelement-Antwortobjekt darstellt.  <br/> |
