...
---
# <a name="inboxurl-mastermailboxtype"></a>InboxUrl (Master Mailbox Type)

Das **InboxUrl (Master Mailbox Type)-** Element ist nur für die interne Verwendung vorgesehen. 
