...
- [<span data-ttu-id="c85cc-285">ExchangeService.FindItems</span><span class="sxs-lookup"><span data-stu-id="c85cc-285">ExchangeService.FindItems</span></span>](http://msdn.microsoft.com/en-us/library/microsoft.exchange.webservices.data.exchangeservice.finditems%28v=exchg.80%29.aspx)    
