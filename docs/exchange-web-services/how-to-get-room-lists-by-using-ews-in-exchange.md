...
- [<span data-ttu-id="1101d-150">Erstellen und Verwalten von Raumpostfächern</span><span class="sxs-lookup"><span data-stu-id="1101d-150">Create and Manage Room Mailboxes</span></span>](http://technet.microsoft.com/de-de/library/jj215781%28v=exchg.150%29.aspx)
