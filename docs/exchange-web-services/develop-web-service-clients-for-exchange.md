...
---
# <a name="develop-web-service-clients-for-exchange"></a>Entwickeln von Webdienstclients für Exchange

Hier finden Sie Informationen zum Entwickeln von EWS- und Webdienst-Clientanwendungen für Exchange.
  
In den Artikeln dieses Abschnitts wird erläutert, wie EWS und Webdienste in Ihren Exchange-Clientanwendungen für Exchange Online, Exchange Online als Teil von Office 365 und lokale Versionen von Exchange ab Exchange 2013 verwendet werden. Außerdem werden Beispiele für die Durchführung bestimmter Aufgaben bereitgestellt. 
...
- [Bezeichner in Exchange](ews-identifiers-in-exchange.md)
